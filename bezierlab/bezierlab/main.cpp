...
/* editgrid demonstrates how a
 4th order grid mesh can rendered with OpenGL evaluators.
 The control points for either grid can be interactively moved in 2D
 by selecting and moving with the left mouse button.   */
